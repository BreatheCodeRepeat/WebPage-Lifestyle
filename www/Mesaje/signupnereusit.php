...
<div id="meniuri">
    ...
    <a href="../SignUp.php" class="mbuton" style="padding:4px 0px 0px 0px; height:46px;">Login/
    Sign up</a>
...
<div id="continut">
 ...
 <p id="Titlu2"> Acest utilizator mai există.Schimbați numele de utilizator !</p>
